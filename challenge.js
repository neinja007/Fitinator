...
function toggle_participant(id, add) {
	if (add) {
		...
		document.getElementById('preview_participants').innerHTML =
			parseInt(document.getElementById('preview_participants').innerHTML) + 1;
	} else {
...
function update_time() {
	document.getElementById('preview_time').innerHTML =
...
function start() {
	...
	let stop7 = false;
	document.getElementById('name').value === ''
		? window.alert('You must enter the name of the challenge!')
		: (stop1 = true);
	document.getElementById('participant_1_name').value === ''
		? window.alert('You must enter the name of participant 1!')
		: (stop2 = true);
	document.getElementById('participant_2_name').value === '' &&
	document.getElementById('participant_2_name').disabled === false
		? window.alert('You must enter the name of participant 2!')
		: (stop3 = true);
	document.getElementById('participant_3_name').value === '' &&
	document.getElementById('participant_3_name').disabled === false
		? window.alert('You must enter the name of participant 3!')
		: (stop4 = true);
	document.getElementById('participant_4_name').value === '' &&
	document.getElementById('participant_4_name').disabled === false
		? window.alert('You must enter the name of participant 4!')
		: (stop5 = true);
	document.getElementById('repetitions').value === ''
		? window.alert('You must enter the repetition goal!')
		: (stop6 = true);
	document.getElementById('hours').value === '0' && document.getElementById('minutes').value < 5
		? window.alert('The challenge must last at least five minutes!')
		: (stop7 = true);
	...
	if (!(stop1 && stop2 && stop3 && stop4 && stop5 && stop6 && stop7)) {
		...
		remaining_seconds =
			...
			parseInt(document.getElementById('hours').value) * 3600 -
			1;
		...
		document.getElementById('target_rpm').innerHTML = (
			60 /
			(total_seconds / parseInt(document.getElementById('repetitions').value))
		).toFixed(1);
		...
		for (let i of ['1', '2', '3', '4']) {
			if (!document.getElementById('participant_' + i + '_name').disabled) {
				document.getElementById('participant_' + i + '_rep_button').style.backgroundColor = document.getElementById(
					'participant_' + i + '_color'
				).value;

				document.getElementById('participant_' + i + '_rep_button').style.borderColor = document.getElementById(
					'participant_' + i + '_color'
				).value;

				document.getElementById('display_participant_' + i + '_color').style.color = document.getElementById(
					'participant_' + i + '_color'
				).value;
				document.getElementById('display_participant_' + i + '_name').innerHTML = document.getElementById(
					'participant_' + i + '_name'
				).value;

				document.getElementById('participant_' + i + '_progress_color').style.backgroundColor = document.getElementById(
					'participant_' + i + '_color'
				).value;

				document.getElementById('name_participant_' + i).innerHTML = document.getElementById(
					'participant_' + i + '_name'
				).value;
			} else {
...
function update_rep_difference() {
	...
	document.getElementById('estimated_reps').innerHTML = Math.round(
		total_seconds / ((total_seconds - remaining_seconds) / rep_total)
	);
	document.getElementById('reps_per_minute').innerHTML = (
		60 /
		((total_seconds - remaining_seconds) / rep_total)
	).toFixed(1);
}
